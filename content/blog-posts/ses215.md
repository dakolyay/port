...
#### 19.10.2021 Analysis and interpretation of data (1)
...
#### 26.10.2021 Analysis and interpretation of data (2)

As we interpret users needs and problems types we had to do an interpretation and categories of resources on which we will further rely. There are various resources available to combat digital illiteracy, and there are many different types and degrees of digital illiteracy. For example, Emmaüs Connect divides users into various categories, all of which are more or less technologically illiterate: novice (never used a computer before), intermediate (basic features only), advanced (Internet, email), and "confirmés" (just need help for punctual, specific tasks).

So we divided resources into these categories:

* Physical Support vs Online Resource

(book vs software, website, tutorials, etc.)

* Formation vs Help for a specific task
* Human contact or not
* Local to Essonne or not

By dividing resources we can find an individual way for every each target user to reach the best circumstances for her or him.

As a result, we ended up having a beautiful division with paid attention to the subject they represent: **user-related, problem-related** and **technology-related**. Depending on this we could summarize our features which we would like to include in future prototype:

![](/images/2021-12-05-17-29-05.png)

#### 02.11.2021 Reporting
...
#### 30.11.2021 Design Space or how to attract students with pink slide

![](/images/photo_2022-01-15-21-51-29.jpeg)

In this lecture, we looked at some important terminology that should be useful in prototyping our project. In vivid slides usually unfamiliar to us SES216 students, we were told about _design space_,  _problem space_ and _design pattern_.

**Design space** is a combination that can stand for coherent and structured representation of actual work, achieved work and next research directions. By the end of the class, we, already formed a group of 5 people to start to brainstorm related to the design place.

The most striking example that surprised me during the prof. Hurron's speech was the telling of the story through data visualisation. In such examples, you can realise that design is not an ultramodern word and does not always denote the fashion industry, but it is a **_tool_**. A tool that helps to have a dialogue with people, a tool that helps us everywhere and always. And the great thing about this tool is that it can and should be controlled and adjusted to suit you.

![](/images/89f9e41b5498b0de87551671800f36e8.jpg)

#### 14.12.2021 The last design class of the 2021 year!

#### 4.01.2022 The first class of the 2022 year!

_...which I could not attend and I had to miss it unfortunately because of my flight from Kazakhstan._ =(
