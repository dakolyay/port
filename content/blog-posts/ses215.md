...
The most striking example that surprised me was the telling of the story through data visualisation. In such examples, you can realise that design is not an ultramodern word and does not always denote the fashion industry, but it is a **_tool_**. A tool that helps to have a dialogue with people, a tool that helps us everywhere and always. And the great thing about this tool is that it can and should be controlled and adjusted to suit you.
